...
export default function SearchBar({ compact = false }: SearchBarProps) {
  ...
  return (
    <div
      data-no-drag-select
      className={`studio-filterbar ${compact ? 'studio-filterbar-compact mt-3 mb-4 sm:mt-3 sm:mb-4' : 'mt-4 mb-5 sm:mt-5 sm:mb-6'}`}
    >
      <div className="relative flex-1 min-w-[220px] z-10">
        ...
        <input
          ...
          type="text"
          placeholder={compact ? '搜索提示词 / 参数 / 尺寸' : '搜索提示词、参数、尺寸、格式...'}
